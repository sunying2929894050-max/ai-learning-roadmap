const TOC_DATA = {
  // ── 前置速通 ──
  0: [{id:"ch0-s0",l:"定位与范围"},{id:"ch0-s1",l:"安装 Python"},{id:"ch0-s2",l:"变量与字符串"},{id:"ch0-s3",l:"函数"},{id:"ch0-s4",l:"列表与循环"},{id:"ch0-s5",l:"字典与 JSON"},{id:"ch0-s6",l:"文件读写"},{id:"ch0-s7",l:"环境变量"},{id:"ch0-s8",l:"pip 与 import"},{id:"ch0-s9",l:"综合实战"}],
  // ── 主轴：0→1 AI 应用 ──
  ...
  8: [{id:"ch8-s0",l:"本章概览"},{id:"ch8-s1",l:"助手在本地跑完了"},{id:"ch8-s2",l:"从脚本到服务"},{id:"ch8-s3",l:"跑在哪：三种环境"},{id:"ch8-s4",l:"生产中的密钥"},{id:"ch8-s5",l:"可观测：日志·监控"},{id:"ch8-s6",l:"延迟与流式输出"},{id:"ch8-s7",l:"作品集：进简历"},{id:"ch8-s8",l:"本章给项目加了什么"},{id:"ch8-s9",l:"知识自测"},{id:"ch8-s10",l:"本章小结"},{id:"ch8-s11",l:"词汇表"}],
  // ── 选修翼：造 AI 路线 ──
  21:[{id:"ch2-s0",l:"本章概览"},{id:"ch2-s1",l:"为什么要学"},{id:"ch2-s2",l:"Python 基础语法"},{id:"ch2-s3",l:"数据科学三件套"},{id:"ch2-s4",l:"线性代数"},{id:"ch2-s5",l:"概率与统计"},{id:"ch2-s6",l:"导数与梯度"},{id:"ch2-s7",l:"实践：数据探索"},{id:"ch2-s8",l:"知识自测"},{id:"ch2-s9",l:"本章小结"},{id:"ch2-s10",l:"词汇表"}],
  22:[{id:"ch3-s0",l:"本章概览"},{id:"ch3-s1",l:"三大范式"},{id:"ch3-s2",l:"监督学习"},{id:"ch3-s3",l:"无监督学习"},{id:"ch3-s4",l:"模型评估"},{id:"ch3-s5",l:"特征工程"},{id:"ch3-s6",l:"实战：Titanic"},{id:"ch3-s7",l:"知识自测"},{id:"ch3-s8",l:"本章小结"},{id:"ch3-s9",l:"词汇表"}],
  23:[{id:"ch4-s0",l:"本章概览"},{id:"ch4-s1",l:"神经网络基础"},{id:"ch4-s2",l:"PyTorch 核心"},{id:"ch4-s3",l:"CNN：图像架构"},{id:"ch4-s4",l:"Transformer & NLP"},{id:"ch4-s5",l:"迁移学习"},{id:"ch4-s6",l:"实战：MNIST"},{id:"ch4-s7",l:"知识自测"},{id:"ch4-s8",l:"本章小结"},{id:"ch4-s9",l:"词汇表"}]
};
